...
<p><strong>Step 2</strong>: Choose <strong>File</strong> &gt; <strong>Open</strong>, go to the directory where the sample project is decompressed, and click <strong>OK</strong>.<br><img style="width: 376.00px" src="https://raw.githubusercontent.com/simgekeser/testRepo/gh-pages/assets/codelabidentity.png" onclick="imageclick(src)"></p>
...
<ul>
  ...
  <p>For Identity Kit, please refer to <a href="https://developer.huawei.com/consumer/en/doc/development/HMSCore-Guides/version-change-history-0000001050040475" target="_blank">latest version</a>.</p>
	</li>
